        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">إضافة امتحان جديد</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('exams.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control" required>
                                        ...
                                        @foreach($types as $examType)
                                            <option value="{{ $examType }}" {{ old('type') == $examType ? 'selected' : '' }}>
                                                @if($examType == 'midterm')
                                                    امتحان نصف الفصل
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="dept" id="dept" class="form-control select2" required>
                                        ...
                                        @foreach($departments as $dept)
                                            <option value="{{ $dept }}" {{ old('dept') == $dept ? 'selected' : '' }}>
                                                {{ $dept }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="year" id="year" class="form-control" required>
                                        ...
                                        @foreach($years as $yr)
                                            <option value="{{ $yr }}" {{ old('year', date('Y')) == $yr ? 'selected' : '' }}>
                                                {{ $yr }} - {{ $yr + 1 }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="pdf">ملف الامتحان (PDF) <span class="text-danger">*</span></label>
                                    <div class="custom-file">
                                        <input type="file" name="pdf" id="pdf" class="custom-file-input" accept=".pdf" required>
        ...
        $('#pdf').change(function() {
            ...
            if (file) {
                ...
                if (fileSize > 10) {
                    ...
                    $(this).val('');
                    $(this).siblings(".custom-file-label").html('اختر ملف PDF');
                }
            }
        });
    });
