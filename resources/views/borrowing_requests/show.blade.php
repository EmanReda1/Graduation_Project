    ...
    <div class="card mb-4">
        ...
        <div class="card-footer">
            <div class="d-flex justify-content-between">
                <div>
                    @if($request->status == 'pending')
                        <a href="{{ route('borrowing-requests.approve', $request->request_id) }}" class="btn btn-success">قبول</a>
                        <a href="{{ route('borrowing-requests.reject', $request->request_id) }}" class="btn btn-danger">رفض</a>
                    @endif
                </div>
                <div>
